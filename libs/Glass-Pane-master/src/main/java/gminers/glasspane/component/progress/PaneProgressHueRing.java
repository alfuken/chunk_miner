...
/**
 * Implements a progress ring that sets it's filled color through a (smoothly animated) hue value rather than exact RGB.
 * 
 * @author Aesen Vismea
 * 
 */
public class PaneProgressHueRing
		extends PaneProgressRing {
